...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'communications_communication', (
        ...
        db.send_create_signal(u'communications', ['Communication'])


    def backwards(self, orm):
        # Deleting model 'Communication'
        db.delete_table(u'communications_communication')
    ...
    models = {
        ...
        u'communications.communication': {
