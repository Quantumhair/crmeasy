...
$(function() {
    $('body').delegate('#new-contact', 'click', function(e) {
        e.preventDefault();
...
$(function() {
    $('body').delegate('.edit-contact', 'click', function(e) {
        e.preventDefault();
        var that = $(this);
        $.get($(this).attr('href'), function(data) {
            $('#new-contact').hide();
...
$(function() {
    $('body').delegate('#contact-form', 'submit', function(e) {
        ...
        $.post(url, form.serialize(), function(data) {
            if ($(data).find('#contact-form').html()) {
...
$(function() {
    $('body').delegate('#id_subject', 'focus', function() {
...
$(function() {
    $('body').delegate('#new-comm', 'click', function(e) {
        e.preventDefault();
        $.get($(this).attr('href'), function(data) {
...
$(function() {
    $('body').delegate('.comm-edit', 'click', function(e) {
        e.preventDefault();
        var that = $(this);
        $.get($(this).attr('href'), function(data) {
...
$(function() {
    $('body').delegate('#comm-form', 'submit', function(e) {
        e.preventDefault();
        var form = $('#comm-form');
        var url = form.attr('action');
        $.post(url, form.serialize(), function(data) {
