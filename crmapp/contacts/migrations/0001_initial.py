...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contacts_contact', (
            ...
            ('uuid', self.gf('shortuuidfield.fields.ShortUUIDField')(unique=True, max_length=22, blank=True)),
    ...
    models = {
        u'accounts.account': {
            ...
            'uuid': ('shortuuidfield.fields.ShortUUIDField', [], {'unique': 'True', 'max_length': '22', 'blank': 'True'})
        },
        u'auth.group': {
