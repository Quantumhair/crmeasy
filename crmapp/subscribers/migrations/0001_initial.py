...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'subscribers_subscriber', (
            ...
            ('user_rec', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ...
            ('stripe_id', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
        ))
    ...
    models = {
        ...
        u'subscribers.subscriber': {
            ...
            'stripe_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'user_rec': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
